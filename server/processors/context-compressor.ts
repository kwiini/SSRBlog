...
const STOPWORDS = new Set([
  ...
  "看", "好", "自己", "这", "那", "里", "把", "被", "从", "向", "对", "用",
  "将", "为", "如", "可", "则", "能", "过", "没", "而", "但", "与", "或",
  "及", "以", "于", "其", "此", "它", "他", "她", "们", "什么", "怎么", "为什么",
  "the", "a", "an", "and", "or", "of", "to", "in", "on", "is", "it", "this",
  "that", "for", "as", "with", "by", "be", "are", "was", "were", "has", "have",
  "had", "not", "no", "but", "if", "then",
])
...
function sentenceSimilarity(sent1: string, sent2: string): number {
  ...
  const lenRatio = Math.min(set1.size, set2.size) / Math.max(set1.size, set2.size)
