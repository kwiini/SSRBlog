 ...
 * 学术论文关键章节提取
 *
 * 策略:按章节标签 (Abstract/Method/Result/Conclusion 等) 定位,
 * 跳到下一章节或终止词 (References/Acknowledgement/Appendix) 之前,
 * 提取每节内容并按 priority 截断,总长不超过 maxLength(默认 6000)。
 * 没有结构化章节时,降级取首 50% + 尾 50%。
 *
 * 省 token 是核心目的:综述通常要喂 10+ 篇论文,只有关键章节才有价值。
 */
